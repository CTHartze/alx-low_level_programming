...
/**
 * sorted_list - Inserts new node in sorted list
 * @ht: refers to sorted hash table
 * @new_node: refers to new node to insert
 * Return: void
 */
 ...
 * @key: refers to key to add the element
 * @value: refers to value to add the element
 *
...
/**
 * shash_table_get - Retrieves value associated with the key
 * @ht: hash table
 * @key: refers to key to retrieve value
 *
 * Return: value or NULL if key is not exitting.
 */
...
/**
 * shash_table_print - Prints the key:value from ht in order
...
/**
 * shash_table_print_rev - Prints the key:value from ht in reverse order
...
/**
 * shash_table_delete - Frees/Deletes hash table and all nodes
