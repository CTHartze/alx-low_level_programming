 ...
 * @e_ident: An array consisting of ELF magic numbers.
 ...
 * @e_ident: An array consisting of ELF magic numbers.
 * Description: Magic numbers are made to be separated by spaces
 */
...
/**
 * print_version - Prints current version of the ELF header.
 * @e_ident: Pointer to an array consisting of the ELF version.
 */
 ...
 * @e_ident: Pointer to array consisting of the ELF ABI version.
 */
 ...
 * @e_entry: pointer to an address of the ELF entry point.
 * @e_ident: pointer to an array consisting of the ELF class.
 */
 ...
 * @elf: pointer to file descriptor of the ELF file
 ...
 * file is not an ELF File exit code 98.
 */
